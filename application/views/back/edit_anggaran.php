...
<html lang="">
  <head>
    ...
    <title>Edit Data Anggaran</title>
		...
		<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
			<div class="panel panel-success">
				<div class="panel-heading">
					<h3 class="panel-title">Edit Data Anggaran Masjid An-Nur Polinema</h3>
				</div>
				<div class="panel-body">
					<?php echo form_open('back/keuangan/update/'.$this->uri->segment(4)); ?>
						...
						<?php foreach ($selectedAnggaran as $key) { ?>
							...
							<label for="">Nama Masjid</label>
								...
								<input type="text" name="pemasukan" class="form-control" value="<?php echo $key->pemasukan; ?>" placeholder="Rp. ....">
								<label for="">Pengeluaran</label>
								<input type="text" name="pengeluaran" class="form-control" value="<?php echo $key->pengeluaran; ?>" placeholder="Rp. ....">
							</div>
